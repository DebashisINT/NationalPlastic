package com.breezenationalplasticfsm.features.logoutsync.presentation
...
import com.breezenationalplasticfsm.CustomConstants
...
import com.breezenationalplasticfsm.features.billing.api.AddBillingRepoProvider
import com.breezenationalplasticfsm.features.billing.model.AddBillingInputParamsModel
...
import com.breezenationalplasticfsm.features.dashboard.presentation.ReasonDialog
...
import com.breezenationalplasticfsm.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
...
import com.breezenationalplasticfsm.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.breezenationalplasticfsm.features.orderhistory.model.*
...
import com.breezenationalplasticfsm.features.quotation.model.AddQuotInputModel
import com.breezenationalplasticfsm.features.shopdetail.presentation.api.EditShopRepoProvider
import com.breezenationalplasticfsm.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.breezenationalplasticfsm.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
...
import com.breezenationalplasticfsm.features.stockCompetetorStock.ShopAddCompetetorStockProductList
...
import com.breezenationalplasticfsm.features.timesheet.model.AddTimeSheetInputModel
import com.breezenationalplasticfsm.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.breezenationalplasticfsm.features.viewAllOrder.model.AddOrderInputParamsModel
import com.breezenationalplasticfsm.features.viewAllOrder.model.AddOrderInputProductList
import com.breezenationalplasticfsm.mappackage.SendBrod
import com.breezenationalplasticfsm.widgets.AppCustomTextView
import com.breezenationalplasticfsm.MonitorService
...
import com.breezenationalplasticfsm.features.addshop.presentation.ShopExtraContactReq
...
import com.breezenationalplasticfsm.features.login.model.GetConcurrentUserResponse
...
import com.breezenationalplasticfsm.features.orderITC.SyncDeleteOpptL
...
import com.breezenationalplasticfsm.features.orderITC.SyncOrdProductL
import com.breezenationalplasticfsm.features.performance.model.Gps_status_list
import com.breezenationalplasticfsm.features.performance.model.UpdateGpsInputListParamsModel
import com.breezenationalplasticfsm.features.returnsOrder.ReturnProductList
import com.breezenationalplasticfsm.features.returnsOrder.ReturnRequest
import com.breezenationalplasticfsm.features.viewAllOrder.model.NewOrderSaveApiModel
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezenationalplasticfsmlogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezenationalplasticfsmlogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezenationalplasticfsmlogsample/log.zip").path);

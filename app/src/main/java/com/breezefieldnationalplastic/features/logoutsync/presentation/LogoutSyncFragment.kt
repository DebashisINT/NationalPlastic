package com.breezefieldnationalplastic.features.logoutsync.presentation
...
import com.breezefieldnationalplastic.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.breezefieldnationalplastic.features.billing.api.AddBillingRepoProvider
import com.breezefieldnationalplastic.features.billing.model.AddBillingInputParamsModel
...
import com.breezefieldnationalplastic.features.dashboard.presentation.ReasonDialog
...
import com.breezefieldnationalplastic.features.document.model.AddEditDocumentInputParams
import com.breezefieldnationalplastic.features.document.model.DocumentAttachmentModel
...
import com.breezefieldnationalplastic.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.breezefieldnationalplastic.features.orderhistory.model.*
...
import com.breezefieldnationalplastic.features.quotation.model.AddQuotInputModel
...
import com.breezefieldnationalplastic.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.breezefieldnationalplastic.MonitorService
...
import com.breezefieldnationalplastic.features.dashboard.presentation.model.AudioSyncModel
...
import com.breezefieldnationalplastic.features.login.model.GetConcurrentUserResponse
...
import com.breezefieldnationalplastic.features.orderITC.SyncOpptProductL
import com.breezefieldnationalplastic.features.orderITC.SyncOrd
import com.breezefieldnationalplastic.features.orderITC.SyncOrdProductL
...
import com.breezefieldnationalplastic.features.returnsOrder.ReturnProductList
                                 ...
                                 doAsync {
                                     ...
                                     uiThread {
                                         ...
                                         try {
                                             ...
                                             var audFile = File("/data/user/0/com.breezefieldnationalplastic/files", fileName)
                                             audFile.delete()
                                         }catch (ex:Exception){
                                             ex.printStackTrace()
                                         }
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldnationalplasticlogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldnationalplasticlogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldnationalplasticlogsample/log.zip").path);

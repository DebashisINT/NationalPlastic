package com.nationalplasticfsm.features.logoutsync.presentation
...
import com.nationalplasticfsm.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.nationalplasticfsm.features.billing.api.AddBillingRepoProvider
import com.nationalplasticfsm.features.billing.model.AddBillingInputParamsModel
...
import com.nationalplasticfsm.features.dashboard.presentation.ReasonDialog
...
import com.nationalplasticfsm.features.document.model.AddEditDocumentInputParams
import com.nationalplasticfsm.features.document.model.DocumentAttachmentModel
...
import com.nationalplasticfsm.features.quotation.model.AddQuotInputModel
import com.nationalplasticfsm.features.shopdetail.presentation.api.EditShopRepoProvider
import com.nationalplasticfsm.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.nationalplasticfsm.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
...
import com.nationalplasticfsm.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.nationalplasticfsm.features.timesheet.model.AddTimeSheetInputModel
...
import com.nationalplasticfsm.features.login.model.WhatsappApiData
import com.nationalplasticfsm.features.performance.model.Gps_status_list
...
import com.nationalplasticfsm.features.returnsOrder.ReturnRequest
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xnationalplasticfsmlogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xnationalplasticfsmlogsample/log.zip").path))).use { out ->

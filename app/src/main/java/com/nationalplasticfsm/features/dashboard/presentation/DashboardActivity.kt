...
import com.nationalplasticfsm.*
import com.nationalplasticfsm.R
import com.nationalplasticfsm.app.*
import com.nationalplasticfsm.app.NewFileUtils.browseDocuments
import com.nationalplasticfsm.app.NewFileUtils.getExtension
import com.nationalplasticfsm.app.domain.*
import com.nationalplasticfsm.app.types.DashboardType
import com.nationalplasticfsm.app.types.FragType
import com.nationalplasticfsm.app.types.TopBarConfig
import com.nationalplasticfsm.app.uiaction.DisplayAlert
import com.nationalplasticfsm.app.utils.*
import com.nationalplasticfsm.app.utils.AppUtils.Companion.isProfile
...
import com.nationalplasticfsm.features.achievement.AchievementFragment
import com.nationalplasticfsm.features.activities.presentation.*
import com.nationalplasticfsm.features.addAttendence.*
...
import com.nationalplasticfsm.features.addAttendence.model.GetReportToResponse
import com.nationalplasticfsm.features.addAttendence.model.Leave_list_Response
import com.nationalplasticfsm.features.addorder.presentation.AddOrderFragment
...
import com.nationalplasticfsm.features.addshop.presentation.OTPVerificationDialog
import com.nationalplasticfsm.features.addshop.presentation.ScanImageFragment
import com.nationalplasticfsm.features.addshop.presentation.ShowCardDetailsDialog
import com.nationalplasticfsm.features.alarm.model.AlarmData
import com.nationalplasticfsm.features.alarm.presetation.AttendanceReportFragment
import com.nationalplasticfsm.features.alarm.presetation.PerformanceReportFragment
import com.nationalplasticfsm.features.alarm.presetation.VisitReportDetailsFragment
import com.nationalplasticfsm.features.alarm.presetation.VisitReportFragment
import com.nationalplasticfsm.features.attendance.AttendanceFragment
...
import com.nationalplasticfsm.features.averageshop.presentation.AverageShopFragment
import com.nationalplasticfsm.features.avgorder.presentation.AverageOrderFragment
import com.nationalplasticfsm.features.avgtimespent.presentation.AvgTimespentShopListFragment
import com.nationalplasticfsm.features.beatCustom.TeamBeatListFragment
import com.nationalplasticfsm.features.billing.presentation.AddBillingFragment
import com.nationalplasticfsm.features.billing.presentation.BillingDetailsFragment
import com.nationalplasticfsm.features.billing.presentation.BillingListFragment
import com.nationalplasticfsm.features.changepassword.presentation.ChangePasswordDialog
...
import com.nationalplasticfsm.features.chat.presentation.*
import com.nationalplasticfsm.features.chatbot.presentation.ChatBotFragment
import com.nationalplasticfsm.features.chatbot.presentation.ChatBotShopListFragment
import com.nationalplasticfsm.features.chatbot.presentation.ReportsFragment
import com.nationalplasticfsm.features.chatbot.presentation.SelectLanguageDialog
import com.nationalplasticfsm.features.commondialog.presentation.CommonDialog
import com.nationalplasticfsm.features.commondialog.presentation.CommonDialogClickListener
import com.nationalplasticfsm.features.commondialogsinglebtn.AddFeedbackSingleBtnDialog
import com.nationalplasticfsm.features.commondialogsinglebtn.CommonDialogSingleBtn
import com.nationalplasticfsm.features.commondialogsinglebtn.OnDialogClickListener
import com.nationalplasticfsm.features.commondialogsinglebtn.TermsAndConditionsSingleBtnDialog
...
import com.nationalplasticfsm.features.dashboard.presentation.api.otpverifyapi.OtpVerificationRepoProvider
import com.nationalplasticfsm.features.dashboard.presentation.api.unreadnotificationapi.UnreadNotificationRepoProvider
import com.nationalplasticfsm.features.dashboard.presentation.getcontentlisapi.GetContentListRepoProvider
import com.nationalplasticfsm.features.dashboard.presentation.model.ContentListResponseModel
...
import com.nationalplasticfsm.features.document.presentation.OpenFileWebViewFragment
import com.nationalplasticfsm.features.dymanicSection.presentation.AddDynamicFragment
import com.nationalplasticfsm.features.dymanicSection.presentation.AllDynamicListFragment
import com.nationalplasticfsm.features.dymanicSection.presentation.DynamicListFragment
import com.nationalplasticfsm.features.dymanicSection.presentation.EditDynamicFragment
import com.nationalplasticfsm.features.gpsDisabilityScreen.GpsDisableFragment
import com.nationalplasticfsm.features.home.presentation.HomeFragment
import com.nationalplasticfsm.features.homelocation.presentation.HomeLocationFragment
import com.nationalplasticfsm.features.homelocation.presentation.HomeLocationMapFragment
import com.nationalplasticfsm.features.know_your_state.KnowYourStateFragment
import com.nationalplasticfsm.features.lead.LeadFrag
import com.nationalplasticfsm.features.lead.ViewLeadFrag
import com.nationalplasticfsm.features.leaveapplynew.LeaveHome
import com.nationalplasticfsm.features.leaveapplynew.model.clearAttendanceonRejectReqModelRejectReqModel
import com.nationalplasticfsm.features.localshops.LocalShopListFragment
import com.nationalplasticfsm.features.localshops.LocalShopListMapFragment
import com.nationalplasticfsm.features.localshops.NearByShopsMapFragment
import com.nationalplasticfsm.features.location.*
...
import com.nationalplasticfsm.features.login.ShopFeedbackEntity
import com.nationalplasticfsm.features.login.model.alarmconfigmodel.AlarmConfigDataModel
...
import com.nationalplasticfsm.features.myallowancerequest.MyallowanceRequestFragment
import com.nationalplasticfsm.features.myjobs.model.CustomerDataModel
import com.nationalplasticfsm.features.myjobs.presentation.*
import com.nationalplasticfsm.features.myorder.presentation.MyOrderListFragment
import com.nationalplasticfsm.features.myprofile.presentation.MyProfileFragment
...
import com.nationalplasticfsm.features.nearbyshops.model.ShopListResponse
import com.nationalplasticfsm.features.nearbyshops.multipleattachImage.MultipleImageFragment
import com.nationalplasticfsm.features.nearbyshops.presentation.BeatListFragment
import com.nationalplasticfsm.features.nearbyshops.presentation.NearByShopsListFragment
import com.nationalplasticfsm.features.nearbyshops.presentation.NewNearByShopsListFragment
import com.nationalplasticfsm.features.nearbyuserlist.presentation.NearbyUserListFragment
import com.nationalplasticfsm.features.newcollection.CollectionDetailsStatusFragment
import com.nationalplasticfsm.features.newcollection.CollectionShopListFragment
import com.nationalplasticfsm.features.newcollection.NewCollectionListFragment
import com.nationalplasticfsm.features.newcollectionreport.*
import com.nationalplasticfsm.features.notification.NotificationFragment
import com.nationalplasticfsm.features.orderList.NewDateWiseOrderListFragment
import com.nationalplasticfsm.features.orderList.NewOrderListFragment
import com.nationalplasticfsm.features.orderList.OrderListFragment
import com.nationalplasticfsm.features.orderdetail.presentation.OrderDetailFragment
import com.nationalplasticfsm.features.orderhistory.ActivityMapFragment
import com.nationalplasticfsm.features.orderhistory.OrderhistoryFragment
import com.nationalplasticfsm.features.orderhistory.TimeLineFragment
import com.nationalplasticfsm.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
...
import com.nationalplasticfsm.features.performanceAPP.PerformanceAppFragment
...
import com.nationalplasticfsm.features.privacypolicy.PrivacypolicyWebviewFrag
...
import com.nationalplasticfsm.features.shopdetail.presentation.*
import com.nationalplasticfsm.features.shopdetail.presentation.api.EditShopRepoProvider
import com.nationalplasticfsm.features.stock.StockDetailsFragment
import com.nationalplasticfsm.features.stock.StockListFragment
import com.nationalplasticfsm.features.stockAddCurrentStock.AddShopStockFragment
...
import com.nationalplasticfsm.features.task.presentation.TaskListFragment
import com.nationalplasticfsm.features.taskManagement.TaskManagementFrag
import com.nationalplasticfsm.features.taskManagement.ViewTaskManagementFrag
import com.nationalplasticfsm.features.timesheet.presentation.AddTimeSheetFragment
import com.nationalplasticfsm.features.timesheet.presentation.EditTimeSheetFragment
import com.nationalplasticfsm.features.timesheet.presentation.TimeSheetListFragment
import com.nationalplasticfsm.features.viewAllOrder.CartFragment
import com.nationalplasticfsm.features.viewAllOrder.OrderTypeListFragment
import com.nationalplasticfsm.features.viewAllOrder.ViewAllOrderListFragment
import com.nationalplasticfsm.features.viewAllOrder.ViewCartFragment
import com.nationalplasticfsm.features.viewAllOrder.orderNew.NewOdrScrListFragment
import com.nationalplasticfsm.features.viewAllOrder.orderNew.NewOrderScrActiFragment
import com.nationalplasticfsm.features.viewAllOrder.orderNew.NewOrderScrOrderDetailsFragment
import com.nationalplasticfsm.features.viewAllOrder.orderNew.NeworderScrCartFragment
import com.nationalplasticfsm.features.viewAllOrder.orderOptimized.OrderProductCartFrag
import com.nationalplasticfsm.features.viewAllOrder.orderOptimized.OrderProductListFrag
import com.nationalplasticfsm.features.viewPPDDStock.ViewOutstandingFragment
import com.nationalplasticfsm.features.viewPPDDStock.ViewPPDDListFragment
import com.nationalplasticfsm.features.viewPPDDStock.ViewPPDDListOutstandingFragment
import com.nationalplasticfsm.features.viewPPDDStock.ViewStockFragment
import com.nationalplasticfsm.features.weather.presentation.WeatherFragment
import com.nationalplasticfsm.mappackage.MapActivity
import com.nationalplasticfsm.mappackage.MapActivityWithoutPath
...
import com.nationalplasticfsm.app.NewFileUtils.browsePDFDocuments
import com.nationalplasticfsm.features.marketAssist.MarketAssistTabFrag
import com.nationalplasticfsm.features.marketAssist.ShopDtlsMarketAssistFrag
import com.nationalplasticfsm.features.marketAssist.ShopListMarketAssistFrag
import com.nationalplasticfsm.features.performanceAPP.OwnPerformanceFragment
import com.nationalplasticfsm.features.performanceAPP.allPerformanceFrag
import com.nationalplasticfsm.features.stockAddCurrentStock.model.MultipleImageFileUploadonStock
...
//        val phototUri = Uri.parse(localAbsoluteFilePath)
            //val fileUrl = Uri.parse(File(Environment.getExternalStorageDirectory(), "xnationalplasticfsmlogsample/log").path);
            //27-09-2021
//            val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xnationalplasticfsmlogsample/log").path);
...
//                BuildConfig.APPLICATION_ID+"/Log/Fsmlog.html").path);
            var currentDBPath="/data/user/0/com.nationalplasticfsm/files/Fsmlog.html"
...
//        startActivity(Intent.createChooser(emailIntent,""))
    ...
    fun openShare(){
        try{
            ...
            val fileUrl1 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xnationalplasticfsmlogsample/log").path);
            val fileUrl2 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xnationalplasticfsmlogsample/log.bak.1").path);
...
//        return super.onCreateOptionsMenu(menu)
    ...
    fun generateNoteOnSD(context: Context?, sFileName: String?, sBody: String?) {
        try {
            val root =  File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xnationalplasticfsmlogsample/log" + ".txt")
            if (!root.exists()) {
                root.mkdirs()
            }
...
//        }
        val bytes = ByteArrayOutputStream()
//        bm!!.compress(Bitmap.CompressFormat.JPEG, 90, bytes)
        var destination = File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xnationalplasticfsmlogsample/log")
        val fo: FileOutputStream
        val fo1:FileWriter
        try {
            fo = FileOutputStream(destination)
